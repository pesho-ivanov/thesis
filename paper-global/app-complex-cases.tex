...
\begin{figure}[H]
  ...
  \subfloat[High divergence]
    {\includegraphics[height=0.25\linewidth]{imgs/limitations/high-error-rate.png}\label{fig:high_error_rate}}
  \hfill
  \subfloat[Long indel]
    {\includegraphics[height=0.25\linewidth]{imgs/limitations/deletion.png}\label{fig:deletion}}
  \hfill
  \subfloat[Short repeats]
    {\includegraphics[height=0.25\linewidth]{imgs/limitations/repeats.png}\label{fig:repeats}}
  \caption[Quadratic exploration behavior for complex alignments]{\textbf{Quadratic exploration behavior for complex alignments}
