...
\begin{figure*}[t]
  \centering
  \subfloat[$d{=}1\%$, exact matches]{\includegraphics[scale=0.55]{plots/tools_e0.01.labels.pdf}
  \label{fig:tools-1}}
  \hfill
  \subfloat[$d{=}4\%$, exact matches]{\includegraphics[scale=0.55]{plots/tools_e0.05.labels.pdf}
  \label{fig:tools-5}}
  \hfill
  \subfloat[$d{=}8\%$, inexact matches]{\includegraphics[scale=0.55]{plots/tools_e0.10.labels.pdf}
  \label{fig:tools-10}}
  \hfill
  \subfloat[$d{=}12\%$, inexact matches]{\includegraphics[scale=0.55]{plots/tools_e0.15.labels.pdf}
  \label{fig:tools-15}}
  \caption{\textbf{Runtime scaling with sequence length on synthetic data.}
