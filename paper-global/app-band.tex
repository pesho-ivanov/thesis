...
\begin{figure*}[t]
  \centering
  \subfloat[$d{=}1\%$, exact matches]{\includegraphics[scale=0.75]{plots/band_e0.01.labels.pdf}
  \label{fig:band-1}}
  \hfill
  \subfloat[$d{=}4\%$, exact matches]{\includegraphics[scale=0.75]{plots/band_e0.05.labels.pdf}
  \label{fig:band-5}}
  \hfill
  \subfloat[$d{=}8\%$, inexact matches]{\includegraphics[scale=0.75]{plots/band_e0.10.labels.pdf}
  \label{fig:band-10}}
  \hfill
  \subfloat[$d{=}12\%$, inexact matches]{\includegraphics[scale=0.75]{plots/band_e0.15.labels.pdf}
  \label{fig:band-15}}%
