...
% CV
\newcommand{\cvleft}[1]{\begin{minipage}[H]{2.5cm}\begin{flushright}#1\end{flushright}\end{minipage}\hspace{5mm}}
\newcommand{\cvright}[1]{\begin{minipage}[H]{8cm}{#1}\end{minipage}}
...
\declaretheorem[name=Paradox]{paradox}
\declaretheorem[name=Open problem]{problem}
...
% Fix spacing after Proof. header.
\labelsep 0.5em
...
%\usepackage{latexsym}  % messes up \sqsubset and \sqsubseteq.
...
\usepackage{tcolorbox}  % python code
