    ...
    \begin{tabularx}{\textwidth}{lX}
    	...
    	edit distance		& minimal weighted number of edits between two sequences \\
		...
		\dijkstra & uninfomred shortest path algorithm \\
		...
		%estimation of the remaining distance \\
		%\,$\sbullet$ admissible		&  \\
    ...
    \begin{tabularx}{\textwidth}{lX}
		...
		$\langle u,i \rangle$ 			& state after aligning  \\
...
%	\,\, Path& A walk without repeating nodes\\
	...
	%\,\, Admissible& $h(u) \leq \min_\pi \cost{\pi}, \pi \colon \pi \text{ starts from } u$\\
