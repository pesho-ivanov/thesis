    ...
    \begin{tabularx}{\textwidth}{lX}
    	...
    	%\midrule%
    	alignment 			& letter-to-letter correspondence (\eg semi-global, global) \\
    	mapping 			& same as alignment but for multiple same reference \\
    	performance 		& Includes runtime and memory footprint \\
		admissible heuristic& Lower bound on the remaining distance ($h \leq \h$) \\
    	%Edit distance 	& Minimal (weighted) number of insertional Includes runtime and memory footprint \\
    	%\bottomrule
    \end{tabularx}
