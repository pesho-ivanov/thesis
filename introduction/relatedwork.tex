...
novel dynamic programming~(DP) technique~\cite{bellman1954theory} of splitting a
task into overlapping subtasks~(or \emph{states}) which can be solved once and
then reused. Each state corresponds to aligning a prefix of the first sequence
to a prefix of the second sequence. Each subtask can be solved by reducing it to
