...
\begin{figure}[t]
  ...
  %\cref{ch:trie}
  %corresponds to
  %\citeauthor{ivanov2020astarix}~(\citeyear{ivanov2020astarix})\citep{ivanov2020astarix},
  %\cref{ch:seed} to
  %\citeauthor{ivanov2022fast}~(\citeyear{ivanov2022fast})\citep{ivanov2022fast},
  %\cref{ch:global} to
  %\citeauthor{koerkamp2022exact}~(\citeyear{koerkamp2022exact})\citep{koerkamp2022exact}}
  \label{tab:ownpubs}
\end{figure}
...
\input{\dir/contrib-methods}
\input{\dir/contrib-results}