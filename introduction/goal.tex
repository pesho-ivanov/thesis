...
\addcontentsline{toc}{section}{\protect\numberline{}{Motivation and goal}}

\paragraph{Goal} In this thesis we consider a novel principled approach that
...
\begin{observation}
    The approximate aligners scale much better in practice than optimal
    aligners.
\end{observation}
...
\begin{observation}
    The same quadratic dynamic programming approach to global alignment
    (Needleman-Wunsch) also solves semi-global and local alignment
    (Smith-Waterman) without additional runtime expenses.
\end{observation}

This observation hints to the potential 
