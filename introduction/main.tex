...
fjdlkfjdsl fjasfjdaslf kajf ladjfl ad jfasdlfjsadlj fsalf jsadl jfsad fjsafj
asdl fajsl fjafj dsl faj fjal fjasl  jfldsfjlads jajf lad fjlal j

%\begin{figure}
%  \raggedleft
%  \begin{minipage}{5cm}
%    \includegraphics[width=5cm]{alignment-types}
%    \caption{Some caption that spans more than a line and some additional text}
%  \end{minipage}
%\end{figure}

%\begin{figure}
%    \includegraphics[width=.6\textwidth,left]{alignment-types}
%    \caption{left aligned image}
%\end{figure}

%\begin{landscape}
%    \vspace*{1cm}
%    \hspace*{2cm}\includegraphics[width = 0.4 \linewidth]{alignment-types}\hspace*{-2cm}
%\end{landscape}

%\begin{minipage}{0.3\linewidth}
%	\includegraphics[width=\linewidth]{alignment-types}
%\end{minipage}\hfil

%\begin{figure} %{r}{0.48\linewidth}
%	\centering
%	\includegraphics[width=\linewidth]{alignment-types}
%	\caption[Alignment types]{Alignment types.}
%	\label{fig:alignment_types}
%\end{figure}
