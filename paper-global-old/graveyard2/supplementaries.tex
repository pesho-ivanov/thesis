...
\begin{figure}[H]
    \centering
    \subfloat[$e=1\%, \spot=1$]{\includegraphics[width=0.5\linewidth]{imgs/scaling/expanded_e0.01.pdf}}
    \subfloat[$e=5\%, \spot=1$]{\includegraphics[width=0.5\linewidth]{imgs/scaling/expanded_e0.05.pdf}}\\
    \subfloat[$e=10\%, \spot=2$]{\includegraphics[width=0.5\linewidth]{imgs/scaling/expanded_e0.1.pdf}}
    \subfloat[$e=15\%, \spot=2$]{\includegraphics[width=0.5\linewidth]{imgs/scaling/expanded_e0.15.pdf}}
