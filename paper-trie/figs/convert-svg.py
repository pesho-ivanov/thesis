...
if __name__ == "__main__":
	...
	parser.add_argument('--directory', default=script_directory, help='Directory to process')
	parser.add_argument('--rel-path', default='./figs', help='Relative path to be used for tex export')
	...
	export_all(args.directory, args.rel_path, args.force, args.simulate)
