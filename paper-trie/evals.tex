\section{Evaluations} \label{TRIEsec:eval}
...
of \astarix on simulated Illumina reads. Implementations and evaluations are
available at \mbox{\astarixurl} and they demonstrates that:
\begin{enumerate}
...
\input{\dir/evals-setting}
\input{\dir/evals-comparison}