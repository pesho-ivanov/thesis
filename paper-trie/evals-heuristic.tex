...
\begin{figure}[t]
  \begin{subfigure}{.45\textwidth}
    \centering
    \includegraphics[width=\linewidth]{\dir/figs/cmp/heuristic_MHC1_cost-t(map).pdf}
  \end{subfigure}~\hspace{1em}
  \begin{subfigure}{.49\textwidth}
    \centering
    \includegraphics[width=\linewidth]{\dir/figs/cmp/heuristic_MHC1_cost-explored_states.pdf}
  \end{subfigure}%
