\begin{algorithm}[H]
	\caption{\A~algorithm}\label{SEEDalg:astar}
	\begin{algorithmic}[1]
...
\subsection{\A Algorithm} \label{SEEDapp:astar}
%
\cref{SEEDalg:astar} shows an implementation of the \A algorithm, taken from
