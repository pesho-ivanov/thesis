\begin{algorithm}[t]
	...
	\begin{algorithmic}[1]
		...
		\EndFunction
		\Statex
		\Function{ProcessSeeds}{$q\colon$ Read} \label{lin:process_seeds}
		...
		\EndFunction
		\Statex
%		\Function{SeedHeuristic}{$\langle u, i \rangle\colon$ State} \label{lin:heuristic-start}
...
%		\Statex
		...
		\EndFunction
        \Statex
        \Function{Align}{$q\colon$ Read} \label{lin:align}
