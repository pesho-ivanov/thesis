...
\begin{figure}[t]
  \begin{subfigure}{.49\textwidth}
    \centering
    \includegraphics[width=\linewidth]{\dir/figures/prefix_vs_seeds_ecoli_250_errors_intervals_cmp_error_rate-explored_per_bp.pdf}
  \end{subfigure}%
  \begin{subfigure}{.45\textwidth}
    \centering
    \includegraphics[width=\linewidth]{\dir/figures/prefix_vs_seeds_ecoli_250_errors_intervals_cmp_error_rate-t(map).pdf}
