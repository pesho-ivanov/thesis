\begin{table}[t]
	\centering
	%\ra{1.2}
	\caption{Runtime and memory comparison of optimal aligners. Simulated
	Illumina and HiFi reads are aligned to linear \textit{E.~coli} and graph MHC
	references. The runtime of the \seedh is expressed as absolute time per
	aligned kbp, while the other aligners are compared to the \seedh at a fold
	change. Additionally, the fraction of explored states is shown for the
	\seedh and the \prefixh.}
	\label{tab:illumina table}
	\sffamily
...
\cmidrule[\heavyrulewidth]{1-7}
      & \phantom{a} & \multicolumn{2}{ c }{\textbf{Illumina}}& \phantom{a} & \multicolumn{2}{ c }{\textbf{HiFi}} &\\
        \cmidrule{3-4} \cmidrule{6-7}\textbf{Tool} & & \textit{E.~coli} & MHC &&
        \textit{E.~coli} & MHC &\\
\cmidrule{1-7}
\mbox{\textbf{Seeds heuristic}}\xspace &&0.019 &0.041 &&0.001 &0.002 & \,s/kbp\\
\quad\textit{(this work)}&&\color{mygrey}{2.4} &\color{mygrey}{2.6}
&&\color{mygrey}{2.4} &\color{mygrey}{1.7} & \,\color{mygrey}{GB (max used)}\\
...
\arrayrulecolor{black!30}\cmidrule{1-7}
...
\arrayrulecolor{black!30}\cmidrule{1-7}
\mbox{\textsc{GraphAligner}}\xspace &&\numprint{424}x &\numprint{212}x &&\numprint{118}x &\numprint{64}x & \\
&&\color{mygrey}{0.2} &\color{mygrey}{0.2} &&\color{mygrey}{3.6} &\color{mygrey}{3.4} & \\
\arrayrulecolor{black!30}\cmidrule{1-7}
\mbox{\textsc{Vargas}}\xspace &&\numprint{133}x &\numprint{67}x &&\numprint{1413}x &\numprint{705}x & \\
&&\color{mygrey}{<0.1}&\color{mygrey}{<0.1}&&\color{mygrey}{7.3} &\color{mygrey}{7.3} & \\
\arrayrulecolor{black!30}\cmidrule{1-7}
\mbox{\textsc{PaSGAL}}\xspace &&\numprint{263}x &\numprint{130}x &&\numprint{1367}x &\numprint{736}x & \\
&&\color{mygrey}{0.6} &\color{mygrey}{0.6} &&\color{mygrey}{0.6} &\color{mygrey}{0.6} & \\
\arrayrulecolor{black}\cmidrule[\heavyrulewidth]{1-7}
\end{tabular}
