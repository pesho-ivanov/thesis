\begin{table}[t]
	\centering
	\ra{0.7}
	\caption[Performance comparison for the seed heuristic (short and long
	reads; linear and graph references)]{Runtime and memory comparison of
...
&&\color{mygrey}{2.4} &\color{mygrey}{2.6}
