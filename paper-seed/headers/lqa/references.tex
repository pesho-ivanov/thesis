...
% use "renewcommand" instead of "newcommand" if e.g. the document class already defines this
\makeatletter
...
% referencing sections without labels (e.g., from citations)
...
% references without labels (e.g., from citations)
